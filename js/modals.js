...
const ROLE_DESCRIPTIONS = {
    ...
    editor:     { desc: 'Введення та керування даними', pages: 'Обсяги, Фінанси, Продукція, Заготівля, Ринок, Введення, Дашборди', caps: ['завантаження', 'керування даними', 'цілі', 'конструктор'] },
