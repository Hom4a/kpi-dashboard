...
export function renderAll() {
    setupChartDefaults();
    const fns = [renderKPIs, renderInsights, renderMainChart, renderCashChart, renderMonthlyChart, renderCumChart, renderYoyChart, renderWdChart, renderTable, renderFinKPIs, renderFinTable, renderForestDashboard];
